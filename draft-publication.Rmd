...
if(Sys.info()[4] == "scott-XPS-15-9560" || Sys.info()[4] %in% c("rhudaur", "rivendell")){
  opts_chunk$set(cache.path = "~/Documents/gramacy_lab/KOHdesign/pubdocs/cache/")
  opts_chunk$set(fig.path = "~/Documents/gramacy_lab/KOHdesign/pubdocs/figs/")
...
}else if(Sys.info()[4] %in% c("Scotts-MacBook-Pro-2.local", "Scotts-MBP", "Scotts-MacBook-Pro.local", "DESKTOP-RFPNN23")){
  
  opts_chunk$set(cache.path = "~/Documents/gramacy-lab/KOHdesign/pubdocs/cache/")
  opts_chunk$set(fig.path = "~/Documents/gramacy-lab/KOHdesign/pubdocs/figs/")
...
}else if(Sys.info()[4] == "some_system"){
  
  stop("Set cache and figure path for your system in first Rmd code chunk")
